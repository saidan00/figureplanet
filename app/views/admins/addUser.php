      ...
      <div class="card card-body mt-5 mb-5">
        ...
        <form action="<?php echo URLROOT; ?>/admins/addUser" method="post">
          ...
          <div class="form-group">
            <label class="col-form-label">Role <span class="text-danger small font-weight-bold">*</span></label>
            <select class="custom-select" name="roleid">
              <?php foreach ($data["roles"] as $role) : ?>
                <option value="<?php echo $role->id; ?>" <?php if ($data["roleid"] == $role->id) echo (" selected"); ?>><?php echo $role->role; ?></option>
              <?php endforeach; ?>
            </select>
          </div>
          ...
          <div class="form-group mb-2">
            <input type="submit" value="Add User" class="btn bg1 btn-block text-light hov1 bo-rad-23">
          </div>
        </form>
      </div>
    </div>
