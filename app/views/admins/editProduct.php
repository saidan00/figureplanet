        ...
        <div class="form-group col-sm-3">
          ...
          <select class="custom-select" name="category">
            <?php for ($i = 0; $i < $data["totalCategories"]; $i++) : ?>
              <option value="<?php echo $data["categories"][$i]->categoryID; ?>" <?php echo ($data["categories"][$i]->categoryID == $data["product"]->category_id) ? 'selected' : '' ?>><?php echo $data["categories"][$i]->categoryName; ?></option>
            <?php endfor; ?>
          </select>
        </div>
        <div class="form-group col-sm-3">
